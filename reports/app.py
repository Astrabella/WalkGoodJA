    ...
    def handle(self, msg):
        try:
            ...
            if(state == 2): # msg is answer to question 2
                ...
                r.set_state(3)
                r.save()
                msg.respond("When did the incident occur? Give time and date (hour:minute, day/month/year")
            ...
            msg.respond("Hello. To begin a report please text 'Report' or 'R' to 123456.")
